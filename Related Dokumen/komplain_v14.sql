...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 10, 2015 at 03:57 AM
...
CREATE TABLE IF NOT EXISTS `komplain` (
  ...
  `KELUHAN` text,
  `SOLUSI` text,
  `STATUS_KOMPLAIN` int(1) NOT NULL DEFAULT '0',
  `KETERANGAN` text,
  `DOKUMEN` longblob,
...
(54, 'Twitter', 'Gangguan', 'Gangguan', '2015-06-22 22:15:00', '2015-07-31', '', '', 0, '', NULL, '123', '', '', '', '', '2015-07-22 22:15:00', 0),
(55, 'Customer Care', 'PSB', 'Belum Setting PSB', '2015-07-08 12:50:49', '0000-00-00', '', '', 0, '', NULL, '456', '', '', '', '', '2015-07-09 12:15:00', 0),
(56, 'Customer Care', 'Balik Nama', 'Lain - Lain', '2015-07-09 09:24:41', '2015-07-09', 'Blablabla', 'Lalala', 1, 'Hubungi lagi', 0x646f6b756d656e2f35362e504e47, '497157', '123456789012', 'Ratih', 'Malang', '0856464', '2015-07-08 21:22:00', 0);
