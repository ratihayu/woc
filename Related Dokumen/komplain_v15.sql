...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 10, 2015 at 11:09 AM
...
CREATE TABLE IF NOT EXISTS `komplain` (
  ...
  `KELUHAN` text,
  `SOLUSI` text,
  `STATUS_KOMPLAIN` varchar(15) NOT NULL DEFAULT '0',
  `KETERANGAN` text,
  `DOKUMEN` longblob,
...
(57, 'Plasa', 'INDIE HOME', 'Gangguan', '2015-07-10 16:05:25', '2015-07-11', '', '', 'In Progress', '', 0x646f6b756d656e2f35372e646f6378, '1', '1234567', 'ALSDJAK', 'DJALK', '9178231', '2015-07-10 09:35:00', 0),
(58, 'Plasa', 'POTS', 'PSB', '2015-07-10 16:05:33', '2015-07-17', '', '', 'Closed', '', NULL, '2', '1237198237', 'DJALSKJDLAK', 'SLJDALKSJD', '018130', '2015-07-10 09:37:00', 0),
(59, 'Twitter', 'INDIE HOME', 'Gangguan', '2015-07-10 16:05:44', '2015-07-11', '', '', 'Decline', '', 0x646f6b756d656e2f35392e6d7033, '3', '912837192783', 'SDJKALJD', 'SDJLALKDJ', '0123801', '2015-07-10 09:38:00', 0),
(60, '147', 'INDIE HOME', 'PSB', '2015-07-10 16:05:56', '2015-07-16', '', '', 'In Progress', '', NULL, '4', '91237918', 'LDJASLDJ', 'SJDLAKJ', '1238910', '2015-07-10 09:38:00', 0);
