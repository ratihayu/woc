...
class Ticket_model extends CI_Model
{
    ...
    public function updateByHD($id,$status,$keterangan_closed,$keterangan_pending,$hd){
        $sql = "UPDATE TICKET SET STATUS='$status', KETERANGAN_CLOSED='$keterangan_closed', KETERANGAN_PENDING='$keterangan_pending', HD='$hd', CLOSED_BY='1' WHERE ID_INCIDENT='$id'";
